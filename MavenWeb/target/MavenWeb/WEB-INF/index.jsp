            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="demoNav">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" target="orders">产品管理</a></dd>
                        <dd><a href="javascript:;" target="orders">作业管理</a></dd>
                        <dd><a href="javascript:;" target="orders">生产计划管理</a></dd>
                        <dd><a href="javascript:;" target="orders">生产派工管理</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">设备管理</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" target="orders">设备台账</a></dd>
                        <dd><a href="javascript:;" target="orders">设备种类</a></dd>
                        <dd><a href="javascript:;" target="orders">设备例检</a></dd>
                        <dd><a href="javascript:;" target="orders">设备故障</a></dd>
                        <dd><a href="javascript:;" target="orders">设备维修</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">工艺监控</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" target="orders">工艺管理</a></dd>
                        <dd><a href="javascript:;" target="orders">工艺要求</a></dd>
                        <dd><a href="javascript:;" target="orders">工艺计划</a></dd>
                        <dd><a href="javascript:;" target="orders">工序管理</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">物料监控</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" target="orders">物料信息</a></dd>
                        <dd><a href="javascript:;" target="orders">物料收入</a></dd>
                        <dd><a href="javascript:;" target="orders">物料消耗</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">质量监控</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" target="orders">不合格品管理</a></dd>
                        <dd><a href="javascript:;" target="orders">成品计量监控</a></dd>
                        <dd><a href="javascript:;" target="orders">成品计数监制</a></dd>
                        <dd><a href="javascript:;" target="orders">工序计量质检</a></dd>
                        <dd><a href="javascript:;" target="orders">工序计数质检</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">人员监控</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" target="orders">部门管理</a></dd>
                        <dd><a href="javascript:;" target="orders">员工管理</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
